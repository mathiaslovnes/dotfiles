return {
  ...
  config = function()
    ...
    require('illuminate').configure {
      ...
      delay = 50, -- with 0 it will highlight as I write
    ...
    -- end
    --
    -- highlight('IlluminatedWord', { bg = '#3e4451', style = 'bold' })
    -- highlight('IlluminatedCWord', { bg = '#3e4451', style = 'bold,underline' })
    -- highlight('IlluminatedWordText', { bg = '#3e4451' })
    -- highlight('IlluminatedWordRead', { bg = '#3e4451' })
    -- highlight('IlluminatedWordWrite', { bg = '#3e4451' })
  end,
}
